...
if __name__ == "__main__":
    ...
    sFilename_mpas_mesh_invert_in = r'/compyfs/liao313/04model/pyhexwatershed/global/pyflowline20251122001/jigsaw/out/invert_mesh.nc'  # specify inverted input file
    ...
    sFilename_out =  r'/qfs/people/liao313/workspace/python/unified_land_river_mesh/figures/global_mesh_visualization.jpg'  # specify output visualization file
