...
#date time
sDate_today = '20251201'  #use a fixed date for easy repeatability
...
dResolution_coastline = 5  #unit in km
...
sFilename_flowline_hydrosheds_raster = os.path.join(sWorkspace_river_network_output, 'river_network_raster_' + sDistance_tolerance + '_' + sDrainage_area_threshold + '.tif')
...
if iFlag_simplify_hydrosheds_river_network == 1:
    ...
    convert_vector_to_global_raster(sFilename_flowline_hydrosheds_out, sFilename_flowline_hydrosheds_raster,
...
if iFlag_debug == 1:
    ...
    change_json_key_value(sFilename_jigsaw_configuration_copy, "sFilename_river_network_raster", sFilename_flowline_hydrosheds_raster) #set the resolution for y direction
