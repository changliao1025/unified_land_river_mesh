...
#date time
sDate_today = '20250926'  #use a fixed date for easy repeatability
...
dResolution_coastline_buffer = dResolution_coastline * 1000.0  #buffer zone for coastline line
...
#river first
dDistance_tolerance = dResolution_land #how far away two river need to be for mesh generation
sDistance_tolerance = "{:.2E}".format(dDistance_tolerance)
sDrainage_area_threshold = "{:.2E}".format(dDrainage_area_threshold ) #convert to m2

#coastline second
sCoastline_buffer = "{:.1E}".format(dResolution_coastline_buffer ) #convert to m
sThreshold_area_island = "{:.1E}".format(dThreshold_area_island ) #convert to m2
