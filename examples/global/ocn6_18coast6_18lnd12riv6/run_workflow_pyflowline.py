...
#date time
sDate_today = '20260203'  #use a fixed date for easy repeatability
...
sFilename_mpas_mesh_netcdf = '/compyfs/liao313/04model/pyhexwatershed/global/pyflowline20260203001/jigsaw/out/invert_mesh.nc'
...
if iFlag_debug == 1:
    ...
    oPyflowline._pyflowline_create_hpc_job(sSlurm_in = 'slurm', hours_in = 23 )
