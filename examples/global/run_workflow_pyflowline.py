...
sDate_today = '20250927'  #use a fixed date for easy repeatability
...
sFilename_mpas_mesh_netcdf = '/compyfs/liao313/04model/pyhexwatershed/global/pyflowline20250926007/jigsaw/out/invert_mesh.nc'
...
if iFlag_process_coastline == 1:
    ...
    add_field_to_vector_file(sFilename_vector_coastline_updated, aField, aValue)
else:
